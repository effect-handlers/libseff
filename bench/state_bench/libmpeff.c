...
const mpe_handlerdef_t  state_def = {MPE_EFFECT(state), NULL, {{MPE_OP_TAIL, MPE_OPTAG(state, get), &_state_get},
    {MPE_OP_TAIL, MPE_OPTAG(state, put), &_state_put}, {MPE_OP_NULL, mpe_op_null, NULL}}};
